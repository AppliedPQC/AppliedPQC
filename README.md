...
- Live PDF: https://appliedpqc.io/AppliedPQC/apqc.pdf
...
```text
https://appliedpqc.io/                     # organization site
https://appliedpqc.io/AppliedPQC/          # this book's landing page
https://appliedpqc.io/AppliedPQC/apqc.pdf  # the book
```

Pages must be enabled once, with its source set to "GitHub Actions", in the
repository settings.

The custom domain `appliedpqc.io` belongs to the organization site,
[AppliedPQC/AppliedPQC.github.io](https://github.com/AppliedPQC/AppliedPQC.github.io),
and GitHub cascades it to every project site in the organization. This book is
a project site, so it is served under that domain by path, at
`appliedpqc.io/AppliedPQC/`, with HTTPS enforced. Nothing in this repository
needs to set a custom domain of its own.
