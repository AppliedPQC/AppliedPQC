...
\begin{itemize}
  ...
  \item \textbf{hashing the message} and message randomization select the path without signer state, while the enormous address space makes accidental collisions negligible; intentional address reuse is forbidden.
\end{itemize}
