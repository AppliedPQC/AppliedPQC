...
In other words, the flow is more like:
...
This design enables reproducibility and makes it easier to integrate into cryptographic protocols.
...
\section{Connecting the story to FIPS 203}

At this point, the whole picture becomes much clearer.
...
So the noise is no longer a mysterious floating-point object. It is a small integer derived deterministically from a seed through a secure expansion procedure.
