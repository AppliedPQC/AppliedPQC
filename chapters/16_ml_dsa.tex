...
The \textbf{Fiat--Shamir transform} turns this interactive protocol into a signature by \emph{removing the verifier}. Instead of waiting for a random challenge, the prover computes the challenge itself as a hash of the commitment together with the message:
\[
c = H(w \,\|\, m).
\]
