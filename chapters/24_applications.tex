...
The consequence is worth knowing: which of the two implementations needs FIPS
certification depends on the group you negotiate. Reading the ordering as a
security judgement gets it backwards.
\end{remark}
