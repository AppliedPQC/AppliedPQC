...
\emph{the math can be perfect and the deployment still broken.} It is the natural
bridge to the final part, where correct, side-channel-safe implementation becomes one
requirement among several for getting these schemes into real systems.
...
The Fujisaki--Okamoto (FO) transform~\cite{fo1999} closes this door with \textbf{implicit
