...
Figure~\ref{fig:ajtai-commit} is a \emph{deterministic} function of
...
Check 1 is not a formality, for the reason overleaf. As drawn this is one round
...
the picture and Greyhound, and it is a good illustration of the theme --- the
algebra was never the hard part, the norms were.

\paragraph{Why the norm check is not a formality.}
