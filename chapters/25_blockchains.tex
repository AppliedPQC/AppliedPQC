...
\]
which is precisely a solution to Module-SIS at bound $2\beta$. The reduction is
one subtraction; there is no random oracle in it and no hash function to model.
This is the sense in which the assumption is \emph{stronger} than a STARK's:
falsifiable and concrete, but an algebraic assumption where the hash-based
family has none.
