...
This chapter assembles the pieces built across this part -- the negacyclic ring and the NTT (Chapter~\ref{ch:ntt}), the toy scheme (Chapter~\ref{ch:toymlkem}), and centered binomial sampling (Chapter~\ref{ch:cbd}) -- into the real standard. FIPS 203, \textbf{ML-KEM} (from the submission CRYSTALS-Kyber)~\cite{fips203,kyber2018}, is the module-lattice-based key-encapsulation standard, and the first of the four algorithms NIST finalized in its post-quantum suite. All algorithm and data-flow details in this chapter follow FIPS 203~\cite{fips203}.
