...
\texttt{sage/fips203\_mlkem.sage} assembles all of them into a complete,
...
The file's \texttt{verify\_ntt\_is\_a\_ring\_isomorphism()} confirms three
...
the fact Experiment~4 could only gesture at with a single base product.

\paragraph{Validation.}
Correctness is not argued, it is measured. The test runner
\texttt{sage/test\_kat.sage} checks the implementation against NIST's ACVP
