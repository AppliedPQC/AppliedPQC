...
The LLL algorithm~\cite{lll1982} is built around the idea that a basis can be improved by repeatedly examining the Gram--Schmidt information. If the current basis is not sufficiently reduced, LLL swaps vectors, rescales, and recomputes the orthogonalized directions until the basis quality is acceptable.
