...
\bottomrule
\end{tabular}
\caption{The multivariate signature bargain. Tiny signatures and fast verification are bought with a very large, incompressible public key, and the family offers signatures but no practical key-encapsulation mechanism. This is close to the mirror image of the hash-based signatures of Chapter~\ref{ch:slhdsa}, which have tiny public keys but large signatures.}
