...
The three standardized parameter sets ML-KEM-512, ML-KEM-768, and ML-KEM-1024 share the same ring but use different parameter tuples: $k=2,3,4$, $\eta_1=3,2,2$, and $(d_u,d_v)=(10,4),(10,4),(11,5)$ respectively~\cite{fips203}. ML-KEM-768 is a common default; this chapter retains only a stripped-down algebraic skeleton.
