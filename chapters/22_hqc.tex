...
explained in full in Section~\ref{sec:fo}.
...
The following table places HQC between its code-based ancestor and the lattice KEM it backs up. The column \emph{what is hidden} accounts for the differences in key size.
